...
public class CommandPromptZipStartHere {
	...
	public static void unzipOneFile(String response, String currentPath){
		...
		//    create a mew ZipEntry ze = null
		//    while (ze = zin.getNextEntry()) != null
		//        if (ze.getName().equals(fileName))
		//               create a new buffer byte[] buffer = new byte[1024];
		//               create int len
	...
	public static void zipList(String response, String currentPath){
		...
		try{
			...
			//create an enum of entries in zip file        Enumeration<? extends ZipEntry> zipEntries = zipFile.entries();
			//loop while zipEntries.hasMoreElements()

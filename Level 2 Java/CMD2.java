...
public class CMD2{
   ...
   //use printf to print out equivalent to:      Volume in drive E:\ is GRCC FLASH (E:)
	...
	public static void rename(String response, String currentPath){ //not completed
		...
		//    File source = new File(currentPath + "\\" + fileName + fileExtension);
		//    File destination = new File(currentPath + "\\" + fileDestinationName + fileDestinationExtension)
		//if !source.exists() then print out "does not exist"
	...
	public static void rdActual(String response, String currentPath){ //completed
 	   ...
 	   //for (String temp : files) {
 	      ...
 	      //File fileDelete = new File(removeDir, temp);
 	      ...
 	      //rdActual("rd " + tempFileName, tempFullPath);
 	   	...
 	   	//if(removeDir.list().length==0){
		//removeDir.delete();
		//System.out.println("Directory is deleted : " + removeDir.getAbsolutePath());
